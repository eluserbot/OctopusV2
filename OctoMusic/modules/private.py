import logging
from OctoMusic.modules.msg import Messages as tr
...
@Client.on_message(filters.command(["start","start@OctoMusicBot"]) & ~filters.private & ~filters.channel)
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "💬 Groups Chat", url=f"https://t.me/{SUPPORT_GROUP}"
                    )
                ],    
                [    
                    InlineKeyboardButton(
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '🔥 Owner 🔥', url="https://t.me/zxsky")],
...
@Client.on_message(filters.command(["help","help@OctoMusicBot"]) & ~filters.private & ~filters.channel)
